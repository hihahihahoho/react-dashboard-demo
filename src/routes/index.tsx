...
const DanhMucMoPage = lazy(() => import(/* webpackChunkName: "form'"*/ '@/pages/quanLyCuaHang/danhMucMo'));
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <WrapperRouteComponent element={<DanhMucMoPage />} titleId="title.account" />,
      },
      {
        path: 'documentation',
