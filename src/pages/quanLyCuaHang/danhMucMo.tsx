...
const DanhMucMoPage: FC = () => {
  return (
    <MyPage
      pageApi={getBusinessUserList}
      searchRender={
        <>
          <SearchItem label="FirstName" name="firstName" type="input" className="form-item-show" />
          <SearchItem label="FirstName" name="firstName1" type="input" className="form-item-show" />
